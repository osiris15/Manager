wa_manager.language = {
	...
	form:{
		...
		reg:{
			...
			success:"Вы успешно зарегистрированны в системе. На указанный вами email выслан код активации аккаунта.",
			exception:{
			...
			items:{
				...
				balance:{
					...
					buttons:{
						...
						transfer: {
							tooltip: "Перевод кредитов на другой акаунт"
						}
					}
				},
				dateRegistration:{
				...
				managerDataAccount:{
					...
					buttons:{
						reset:{
							...
							notification:"Сброс настроек аккаунта удалит все настройки связанные с вашими сайтами без возможности восстановления. Вы действительно хотите продолжить?",
		...
		messagebox:{
			...
			type:{
				...
				setGeoTargeting:{
					...
					geoIs0: "Вы настроили геотаргетинг так, что в сумме по странам он равен 0%. Это приведет к тому, что вы получите трафик из всех доступных стран. Вы точно хотите продолжить?",
					enterTextToFind: "Введите текст для поиска в списке",
				...
				setTimeTargeting:{
					title:"Настройка временного таргентинга",
					text:"Настройте временной таргетинг по своему желанию. Удерживайте клавижу SHIFT для настройки линии максимальных значений таргетинга и клавишу CTRL для настройки линии минимальных значений таргентинга.",
					graphName:"График временного таргентинга"
				},
				setClickTargeting:{
				...
				taskAdd:{
					...
					tab_1:"Настройки 1",
					tab_2:"Настройки 2",
					timeBeforeAfterClick:"Время до и после клика",
					rangeSizeUniqTime:"Размер подсети разброса и время уникальности IP",
					nameTask:{
						text:"Имя задания",
						tooltip:"Имя задания поможет вам не запутаться в большом списке заданий.",
						error:"Не было заполнено поле с имененм задания или оно было заполненно некорректно."
					},
					extSource:{
						text:"Внешний источник",
						tooltip:"URL до файла внешнего источника",
						error:"Не было заполненно поле с внешним источником задания или оно было заполненно некорректно."
					},
					domain:{
						text:"Домен",
						tooltip:"Домен на котором будет выполняться текущее задание.",
						error:"Не было заполнено поле с доменом задания или оно было заполненно некорректно."
					},
					mask:{
						text:"Маска",
						tooltip:"Строка по которой будет выполняться поиск эллемента страницы для клика.",
						error:"Не было заполнено поле с маской задания или оно было заполненно некорректно."
					},
					ignoreGU:{
						text:"Игнорировать глобальную уникальность",
						tooltip:"Поставив здесь галочку, вы сможете получить больше трафика, но его качество может значительно ухудшиться."
					},
					allowProxy:{
						text:"Разрешить прокси трафик",
						tooltip:"Поставив здесь галочку, вы сможете получить больше трафика, но его качество может значительно ухудшиться."
					},
					beforeClick:{
						tooltip:"Время которое пройдет до выполнения клика. Число должно быть кратно 10. Единица измерения: секунда.",
						error:"Не было заполнено поле с временем до клика или оно было заполненно некорректно. Число должно быть кратно 10."
					},
					afterClick:{
						tooltip:"Время которое пройдет после выполнения клика. Число должно быть кратно 10. Единица измерения: секунда.",
						error:"Не было заполнено поле с временем после клика или оно было заполненно некорректно. Число должно быть кратно 10."
					},
					rangeSize:{
						text:"Размер подсети разброса",
						tooltip:"Размер подсети разброса определяет размер диапазона, IP которого будут считаться соседями по подсети. Чем больше размер, тем более отдаленные друг от друга IP будут считаться произошедшими из одной подсети.",
						error:"Проверьте правильность ввода поля размера подсети разброса. Минимальное значение " + wa_api.Constants.Limit.Task.RangeSize.Value.Min + ", максимальное значение " + wa_api.Constants.Limit.Task.RangeSize.Value.Max + "."
					},
					uniqTime:{
						text:"Время уникальности IP",
						tooltip:"Время уникальности определяет время (в минутах), в течении которого один IP не может совершить по маске более одного перехода. Единица измерения: минута.",
						error:"Проверье правильность ввода поля времени уникаьности IP. Минимальное значение " + wa_api.Constants.Limit.Task.UniqPeriod.Value.Min + ", максимальное значение " + wa_api.Constants.Limit.Task.UniqPeriod.Value.Max + ". Время указывается в минутах."
					},
					cost: {
						text: "Стоимость выполнения задания",
						tooltip: "Здесь отображается стоимость выполнения задания с текущими настройками.",
						error: ""
					},
					exception:{
						LimitExceeded:{
							text:"Вы исчерпали лимит на колличество заданий в одной папке аккаунта."
						}
					}
				},
				editTask:{
				...
				setTargetingCountry: {
					title: "Настройка геотаргетинга выбранной страны",
					text: ""
				},
				confirmRegister: {
					title: "Активация аккаунта",
					text: "Пожалуйста введите email вашего аккаунта и код активации, который был выслан на этот email после регистрации.",
					success: "Аккаунт успешно активирован.",
					mail:{
						text:"Email",
						tooltip:"Введите адрес email, на который вы регистрировали аккаунт.",
						error:"Не было заполнено поле с email или оно было заполненно некорректно."
					},
					codeConfirm:{
						text:"Код подтверждения",
						tooltip:"Введите код подтверждения, который был выслан на указанный вами email при регистрации.",
						error:"Не было заполнено поле с кодом подтверждения или оно было заполненно некорректно."
					},
					exception: {
						WrongConfirmCode: {
							text: "Неверно введен код подтверждения или email."
						}
					}
				},
				setAccountPassword: {
					title: "Изменение пароля аккаунта",
					text: "Пожалуйста, введите желаемый пароль аккаунта.",
					success: "Запрос на изменение пароля аккаунта успешно отправлен. На ваш email будет выслан код подтверждения данной операции.",
					password_error: "Ошибка при заполнении полей ввода пароля: пароль либо не введен, либо пароли не совпадают.",
					password:{
						text:"Новый пароль",
						tooltip:"Введите новый пароль аккаунта.",
						error:"Не было заполнено поле с новым паролем аккаунта или пароли не совпадают."
					},
					repeat_password: {
						text:"Введите пароль еще раз",
						tooltip:"Повторно введите новый пароль аккаунта.",
						error:"Не было заполнено поле с повторным вводом пароля аккаунта или пароли не совпадают."
					}
				},
				confirmSetAccountPassword: {
					title: "Подтверждение изменения пароля аккаунта",
					text: "Пожалуйста введите код подтверждения, который был выслан вам на email.",
					success: "Пароль успешно изменен",
					codeConfirm:{
						text:"Код подтверждения",
						tooltip:"Введите код подтверждения, который был выслан на ваш email.",
						error:"Не было заполнено поле с кодом подтверждения или оно было заполненно некорректно."
					},
					exception: {
						InvalidCode: {
							text: "Неверно введен код подтверждения."
						}
					}
				},
				confirmSendCredits: {
					title: "Подтверждение перевода кредитов аккаунта",
					text: "Пожалуйста введите код подтверждения, который был выслан вам на email.",
					success: "Перевод на сумму <b>%CREDITS%</b> кредитов успешно произведен.",
					codeConfirm:{
						text:"Код подтверждения",
						tooltip:"Введите код подтверждения, который был выслан на ваш email.",
						error:"Не было заполнено поле с кодом подтверждения или оно было заполненно некорректно."
					...
					exception: {
						...
						LowBalance: {
							text: "Недостаточно кредитов на балансе аккаунта."
						},
						InvalidRecipient: {
				...
				sendCredits: {
					title: "Перевод кредитов на другой аккаунт",
					text: "",
					success: "Заявка на перевод кредитов успешно отправлена. На ваш email отправлен код подтверждения.",
					recipient:{
						text:"Получатель",
						tooltip:"Введите email получателя, на аккаунт которого вы хотите отправить кредиты.",
						error:"Не было заполнено поле с получателем или оно было заполненно некорректно."
					},
					amount: {
						text:"Колличество кредитов",
						tooltip:"Введите колличество кредитов, которое вы хотите перевести.",
						error:"Не было заполнено поле с колличеством кредитов или оно было заполненно некорректно."
					},
					cost: {
						text:"Сумма кредитов c учетом комиссии системы",
						tooltip:"Здесь отображается сумма колличества кредитов, которые вы хотите перевести и процента системы за этот перевод.",
						error:""
					},
					exception: {
						LowBalance: {
		...
		tasks:{
			...
			infoHead:{
				name:"Имя задания",
				domain:"Домен задания",
				mask:"Маска"
			},
			item:{
				emptyName:"Задание без имени",
				button:{
					'delete':{
						notification:"Удаление выбранных заданий приведет к безвозратному удалению как самих заданий так и всех их настроек. Вы действительно хотите продолжить?"
					}
				},
				icon:{
					'delete':{
						notification:"Удаление задания приведет к безвозратному удалению как самого задания так и всех его настроек. Вы действительно хотите продолжить?"
					},
					rename:{
	...
	control:{
		...
		iconBox:{
			items:{
				...
				graphic:{
					tooltip:"Настройки временного таргетинга"
				},
				transfer: {
					tooltip: "Перевести"
				}
