		...
		messagebox:{
			...
			type:{
				...
				taskAdd:{
					...
					beforeClick:{
						tooltip:"Время которое пройдет до выполнения клика. Число должно быть кратно 10.",
						error:"Не было заполнено поле с временем до клика или оно было заполненно некорректно. Число должно быть кратно 10."
					},
					afterClick:{
						tooltip:"Время которое пройдет после выполнения клика. Число должно быть кратно 10.",
				...
				confirmSendCredits: {
					...
					text: "Пожалуйста введите код подтверждения, который был выслан вам на email.",
					success: "Кредиты успешно переведены.",
					codeConfirm:{
						text:"Код подтверждения",
						tooltip:"Введите код подтверждения, который был выслан на ваш email.",
						error:"Не было заполнено поле с кодом подтверждения или оно было заполненно некорректно."
				...
				sendCredits: {
					...
					text: "Для перевода кредитов на другой аккаунт введите email получателя и колличество кредитов.",
